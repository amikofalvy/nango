...
// This could be actions such as authenticating users and/or performing
// authorizations to see if they have the authorization to create a new
// nango connection with the given integration and connection id.

// Create the hmac digest for the nango frontend sdk
